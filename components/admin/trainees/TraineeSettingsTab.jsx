/**
 * Trainee Settings Tab Component
 ...
 * @param {boolean} props.isDiscontinued - Whether trainee is discontinued
 * @param {string} props.status - Current trainee status
 */
const TraineeSettingsTab = memo(({
  register,
  errors,
  imagePreview,
  onImageChange,
  ...
  return (
    <div className="space-y-6" role="tabpanel" aria-labelledby="settings-tab">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-amber-700">
                  RFID tag and photo are automatically removed for discontinued trainees 
      ...
      <fieldset className="space-y-4">
        <legend className="text-base font-medium">Trainee Photo</legend>
          ...
          <Label htmlFor="photo" className="text-sm font-medium">
            ...
            {isDiscontinued && (
              <span className="ml-2 text-amber-600 font-normal">
                (Removed for discontinued trainees)
              </span>
            )}
          </Label>
              ...
              {!isDiscontinued ? (
                ...
                <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center bg-muted/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Photo upload disabled for discontinued trainees
                  </p>
                </div>
              )}
      ...
      <fieldset className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="rfid_tag"
            type="text"
            placeholder={isDiscontinued ? 'RFID tag removed' : 'Enter RFID tag number'}
            disabled={isDiscontinued}
            aria-describedby={
              errors.rfid_tag ? 'rfid_tag-error' : 'rfid_tag-help'
            }
            aria-invalid={!!errors.rfid_tag}
            className={isDiscontinued ? 'bg-muted' : ''}
            {...register('rfid_tag', {
              required: !isDiscontinued ? 'RFID Tag is required for active trainees' : false,
              pattern: {
                value: /^[A-Fa-f0-9]+$/,
          ...
          {!errors.rfid_tag && (
            <p id="rfid_tag-help" className="text-xs text-muted-foreground">
              {isDiscontinued 
                ? 'RFID tag is automatically removed for discontinued trainees'
            ...
            <CardContent className="pt-4">
              <div className="text-sm">
                ...
                <ul className="text-blue-700 space-y-1 list-disc list-inside">
                  <li>Each trainee must have a unique RFID tag</li>
...
TraineeSettingsTab.displayName = 'TraineeSettingsTab';

export default TraineeSettingsTab;
