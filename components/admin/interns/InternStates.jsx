/**
 * Loading and empty state components for intern management
 ...
 */
export const LoadingState = memo(({ message = 'Loading interns...' }) => (
 ...
 * @param {Object} props - Component props
 * @param {Function} props.onAddIntern - Handler for adding first intern
    ...
    <CardContent className="flex flex-col items-center justify-center py-12 space-y-4">
      ...
      <div className="text-center space-y-2">
        <h3 className="text-lg font-semibold">
          {hasFilters ? 'No interns found' : 'No interns yet'}
        </h3>
        <p className="text-muted-foreground max-w-md">
          {hasFilters 
            ? 'No interns match your current search criteria. Try adjusting your filters or search terms.'
  ...
  <Card className="border-destructive">
    <CardContent className="flex flex-col items-center justify-center py-12 space-y-4">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground max-w-md">
          {error || 'An error occurred while loading intern data. Please try again.'}
        </p>
      </div>
