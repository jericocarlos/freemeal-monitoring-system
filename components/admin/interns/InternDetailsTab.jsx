/**
 * Intern Details Tab Component
 * Handles the basic intern information form fields
 */
  ...
  return (
    <div className="space-y-6" role="tabpanel" aria-labelledby="details-tab">
      ...
      <fieldset className="space-y-4">
        <legend className="sr-only">Basic Intern Information</legend>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {/* Intern ID */}
          <div className="space-y-2">
            <Label htmlFor="ashima_id" className="text-sm font-medium">
              Intern ID <span className="text-destructive" aria-label="required">*</span>
            </Label>
            <Input
              id="ashima_id"
              type="text"
              autoComplete="intern-id"
              disabled={isEditing}
              ...
              {...register('ashima_id', { 
                ...
                pattern: {
                  value: /^[A-Za-z0-9-_]+$/,
                  message: 'Intern ID can only contain letters, numbers, hyphens, and underscores'
                }
              })}
            />
            {errors.ashima_id && (
            ...
            {isEditing && (
              <p className="text-xs text-muted-foreground">
                Intern ID cannot be changed after creation
              </p>
            )}
          </div>
      ...
      <fieldset className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            {!isEditing && (
              <p className="text-xs text-muted-foreground">
                Status can only be changed when editing an existing intern
              </p>
            )}
          </div>
        </div>
...
InternDetailsTab.displayName = 'InternDetailsTab';

export default InternDetailsTab;
